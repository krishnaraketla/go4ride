...
async def get_settings(
    ...
    data = await settings_service.get_settings(db, rider)
    return ok(data, message="Settings retrieved")
...
async def update_settings(
    ...
    data = await settings_service.update_settings(db, rider, body)
    return ok(data, message="Settings updated")
